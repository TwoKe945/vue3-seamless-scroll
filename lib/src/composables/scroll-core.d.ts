 ...
 * @returns
 */
export declare function defineTableScroll<T>(columns: readonly Column[], formatStyle?: (key: string, value: any) => any, tableClass?: string, headerClass?: string, bodyClass?: string, bodyRowClass?: string): import("vue").DefineComponent<{
    data: {
        type: PropType<T[]>;
        required: true;
    };
